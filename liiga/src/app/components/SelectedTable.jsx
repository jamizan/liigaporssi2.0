...
export default function SelectedTable({
    ...
    return(
        <table className="text-center w-[100%]">
            <tbody>
                <tr>
                    <td className="border-2 w-[10%] relative bg-white" id="player-1">
                    ...
                    <td className="border-2 w-[10%] relative bg-white" id="player-2">
                    ...
                    <td className="border-2 w-[10%] relative bg-white" id="player-3">
                    ...
                    <td className="border-2 w-[10%] relative bg-white" id="player-4">
                    ...
                    <td className="border-2 w-[10%] relative bg-white" id="player-5">
                    ...
                    <td className="border-2 w-[10%] relative bg-white" id="player-6">
